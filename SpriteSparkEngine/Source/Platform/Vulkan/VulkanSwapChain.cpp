...
namespace SpriteSpark {
    ...
    VkResult VulkanSwapChain::acquireNextImage(uint32_t* imageIndex) {
        ...
        VkResult result = vkAcquireNextImageKHR(m_Device.device(), m_SwapChain, std::numeric_limits<uint64_t>::max(), m_ImageAvailableSemaphores[m_CurrentFrame], VK_NULL_HANDLE, imageIndex); // m_ImageAvailableSemaphores[m_CurrentFrame] must be a not signaled semaphore
    ...
    void VulkanSwapChain::createSwapChain() {
        ...
        createInfo.oldSwapchain = m_OldSwapChain ? m_OldSwapChain->m_SwapChain : nullptr;
